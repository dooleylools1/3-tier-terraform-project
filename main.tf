...
terraform {
  backend "s3" {
    bucket         = "tfstate-remote-backend-004"
...
module "alb" {
  ...
  apci_jupiter_public_subnet_az_2a = module.vpc.apci_jupiter_public_subnet_az_2a
  apci_jupiter_public_subnet_az_2b = module.vpc.apci_jupiter_public_subnet_az_2b
  tags                             = local.project_tags
